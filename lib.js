...
let wordsLib = [
    ...
    [ 'beaver', 'бобр' ],
    [ 'beckon', 'манить' ],
    [ 'become of', 'случиться с к-л впоследствии' ],
    [ 'beef', 'говядина' ],
    ...
    [ 'break down', 'ломаться' ],
    [ 'break into (break in)', 'проникнуть, вломиться' ],
    ...
    [ 'customer', 'клиент' ],
    [ 'customs', 'таможня' ],
    [ 'cut across', 'пересечь, срезать путь' ],
    ...
    [ 'endeavor (endeavour)', 'стремиться, стараться, попытка' ],
    ...
    [ 'face up to', 'принять (обстоятельства)' ],
    ...
    [ 'grind (ground, groud)', 'молоть, измельчать' ],
    ...
    [ 'grove', 'лесок' ],
    [ 'grow (grew, grown)', 'становиться' ],
    [ 'grow (grew, grown)', 'расти или выращивать' ],
    [ 'grow up', 'вырастать' ],
    [ 'growl', 'рычать' ],
    [ 'grudge', 'обида, злоба' ],
    ...
    [ 'hurt (hurt, hurt)', 'причинять боль или болеть' ],
    [ 'hush', 'молчать' ],
    ...
    [ 'intercept', 'перехватить, перехватить' ],
    ...
    [ 'meet (met, met)', 'встретить или познакомиться' ],
    [ 'melon', 'дыня' ],
    ...
    [ 'mess with', 'возиться, связываться и т.д.' ],
    ...
    [ 'outstanding', 'неоплаченный, нерешённый' ],
    ...
    [ 'pour', 'лить' ],
    [ 'pour in (into)', 'хлынуть, заполонить' ],
    ...
    [ 'put in', 'вложить' ],
    [ 'put off', 'отвратить, отвлечь и т. д.' ],
    [ 'put off', 'откладывать' ],
    [ 'put on', 'надеть' ],
    ...
    [ 'quit (quit, quit)', 'бросить, покинуть, перестать' ],
    [ 'quite', 'вполне или более-менее' ],
    ...
    [ 'shake (shook, shaken)', 'пожать (руки)' ],
    ...
    [ 'shrimp', 'креветка' ],
    [ 'shrine', 'святыня' ],
    [ 'shrink (shrank, shrunk)', 'сжаться, съёжиться' ],
    ...
    [ 'spring (sprang, sprung)', 'источник, проистекать' ],
    ...
    [ 'teenage', 'возраста 1-19' ],
    [ 'tell apart', 'различать' ],
    [ 'tell from', 'отличить' ],
    [ 'tell off', 'ругать' ],
    [ 'tell on', 'донести на кого-то' ],
    [ 'temper', 'характер' ],
    [ 'temple', 'храм' ],
    [ 'temple', 'висок' ],
    [ 'temporary', 'временный' ],
